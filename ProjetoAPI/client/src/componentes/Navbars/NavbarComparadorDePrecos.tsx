...
function NavbarComparadorDePrecos() {
                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                    <ul className='navbar-nav mt-auto'>
                        <li className="nav-item">
                            <a className="nav-link text-white" href="#" style={{ fontSize: '28px'}}>Comparador de Preços </a>
                        </li>
                    </ul>
...
export default NavbarComparadorDePrecos;
