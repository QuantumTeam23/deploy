...
function EditarUsuario() {
    ...
    const handleEdit = () => {
        ...
        if (dadosMudaram) {
            if (idParceiro !== null) {
                fetch(`https://server-pi-blue.vercel.app/editar-usuario-comum-parceiro/${idParceiro}`, {
                    method: 'PUT',
                    headers: {
                ...
                fetch(`https://server-pi-blue.vercel.app/editar-usuario-comum-estabelecimento/${idEstabelecimento}`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                    },
