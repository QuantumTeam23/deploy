...
function TransacaoDoacao() {
  ...
  const handleConfirm = () => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        fetch(`https://server-pi-blue.vercel.app/transacaoParceiroEstab/${idParceiro}`, {
          method: "PUT",
          headers: {
        ...
        .then((response) => {
          if (response.status === 500) {
            ...
            fetch("https://server-pi-blue.vercel.app/insertAcaoTransacoes", {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
              },
  ...
  useEffect(() => {
    ...
    fetch(`https://server-pi-blue.vercel.app/listCarteira/${idParceiro}`)
