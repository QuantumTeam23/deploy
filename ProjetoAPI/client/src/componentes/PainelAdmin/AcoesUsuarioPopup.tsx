...
export default function AdicionarUsuarioPopup({ open, onClose }) {
...
export function EditarUsuarioPopup({ open, onClose }) {
  const handleClose = () => {
    onClose();
  };
...
export function RemoverUsuarioPopup({ open, onClose, nomeContato }) {
  const handleClose = () => {
    onClose();
  };
