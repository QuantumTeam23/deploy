...
async function SelectToEdit(req, res) {
    ...
    if (tipo ==='ComumParceiro') {
        let SQL = "SELECT parceiro_email, parceiro_senha, parceiro_logradouro, parceiro_logradouro_numero, parceiro_bairro, parceiro_cidade, parceiro_estado, parceiro_cep, parceiro_regiao, parceiro_cidades_atende FROM parceiros WHERE parceiro_ID = '"+id+"'"
...
async function SelectToEditAdmin(req, res) {
    ...
    if (tipo ==='Parceiro') {
        let SQL = "SELECT parceiro_email, parceiro_senha, parceiro_logradouro, parceiro_logradouro_numero, parceiro_bairro, parceiro_cidade, parceiro_estado, parceiro_cep, parceiro_regiao, parceiro_cidades_atende FROM parceiros WHERE parceiro_razao_social = '"+razaoSocial+"'"
